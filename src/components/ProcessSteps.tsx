  ...
  return (
    <section className="py-16 md:py-20 bg-white" id="process">
      <div className="container mx-auto px-4 md:px-8">
        {/* Section Header - Priorité 2 : Plus impactant */}
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-african-violet to-blue-green bg-clip-text text-transparent mb-6">
            Comment nous procédons
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Une approche simple et éprouvée en 3 étapes pour transformer votre entreprise avec l'IA
          </p>
          <div className="w-24 h-1 bg-gradient-to-r from-african-violet to-blue-green mx-auto rounded-full mt-6"></div>
        </div>
